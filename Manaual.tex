...
\title{JB/ICPC Template Manaual}
\author{Carry Rainyday}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[C]{JB/ICPC Template Manaual, Carry Rainyday}
\begin{document}\small
\begin{titlepage}
\begin{center}
\vspace*{0.5cm}\includegraphics[width=0.75\textwidth]{logo.jpg} \\ [2cm]
\HRule \\ [1cm]
\textbf{\Huge{JB/ICPC Template Manaual}} \\ [0.5cm]
\HRule \\ [4cm]
\textbf{\Huge{Northeast Agricultural University}} \\ [1cm]
\LARGE{Carry Rainyday}
\vfill
\Large{\today}
\end{center}
\clearpage
